...
while(cap.isOpened()):
    ...
    if keyPress == ord('q'):
      ...
      ####
      ####
              def overlay_videos(analog_cap, recording_out, COMBO_cap, mini_size=(256, 192), position=(10, 10)):
                  ...
                  analog_cap = cv2.VideoWriter(output_path, main_fourcc, main_fps, (main_width, main_height))
